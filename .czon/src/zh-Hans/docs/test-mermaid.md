---
"title": "Mermaid图表测试文档"
"summary": "本文档是一个测试文件，旨在验证CZON平台对Mermaid图表的渲染支持。文档中提供了流程图、序列图、甘特图、类图、状态图和饼图等多种\
  Mermaid图表类型的示例，展示了从基本结构到复杂应用的图表定义。此外，文档还包含一个错误语法测试，用于验证系统对错误图表的处理能力。通过这些示例，文档\
  全面测试了CZON平台中Mermaid集成的功能性和健壮性，确保图表能够正确渲染并处理异常情况。"
"tags":
  - "Mermaid"
  - "图表测试"
  - "CZON"
