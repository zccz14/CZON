---
"title": "AI分析报告生成基础规则"
"summary": "本文档为AI分析报告生成提供了基础规则，强调必须严格遵循文档阅读流程，包括获取文件列表、分批阅读与摘要、上下文管理、完整性验证和生成报\
  告五个阶段。核心原则包括逐一阅读所有文件、以事实为依据、规范引用链接、考虑时间权重等。通用规则要求报告以特定格式开头，输出到指定目录，并禁止在阅读完所有文\
  件前生成报告或跳过任何文件。"
"tags":
  - "AI分析"
  - "报告生成"
