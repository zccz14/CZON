---
"title": "Тестовий документ з діаграмами Mermaid"
"summary": "Цей документ є тестовим файлом, призначеним для перевірки підтримки рендерингу діаграм Mermaid на платформі CZON. У документі наведено приклади різних типів діаграм Mermaid, таких як блок-схеми, діаграми послідовностей, діаграми Ганта, діаграми класів, діаграми станів та кругові діаграми, демонструючи визначення діаграм від базової структури до складних застосувань. Крім того, документ містить тест з помилковим синтаксисом для перевірки здатності системи обробляти некоректні діаграми. Завдяки цим прикладам документ всебічно тестує функціональність та надійність інтеграції Mermaid у платформі CZON, гарантуючи коректний рендеринг діаграм та обробку виняткових ситуацій."
"tags":
  - "Mermaid"
  - "Тестування діаграм"
  - "CZON"
...
Це тестовий файл для перевірки функції рендерингу діаграм Mermaid у CZON.
...
## Приклад діаграми послідовностей
