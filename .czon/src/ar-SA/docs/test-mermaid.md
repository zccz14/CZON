...
"summary": "هذه الوثيقة هي ملف اختبار يهدف إلى التحقق من دعم منصة CZON لعرض مخططات Mermaid. توفر الوثيقة أمثلة لأنواع متعددة من مخططات Mermaid مثل المخططات الانسيابية، ومخططات التسلسل، ومخططات جانت، ومخططات الفئات، ومخططات الحالة، والمخططات الدائرية، مما يُظهر تعريف المخططات من البنية الأساسية إلى التطبيقات المعقدة. بالإضافة إلى ذلك، تحتوي الوثيقة على اختبار لبناء جملة خاطئ للتحقق من قدرة النظام على معالجة المخططات غير الصحيحة. من خلال هذه الأمثلة، تختبر الوثيقة بشكل شامل وظائف وقوة تكامل Mermaid في منصة CZON، مما يضمن عرض المخططات بشكل صحيح والتعامل مع الحالات غير الطبيعية."
"tags":
  - "Mermaid"
  - "اختبار المخططات"
  - "CZON"
