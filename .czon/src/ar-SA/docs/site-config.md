...
- إعلان Sitemap في ملف `robots.txt`
...
تكوين روابط التنقل السريع، يعرض روابط التنقل في رأس الصفحة.
...
- **الأجهزة المحمولة**: عرض أيقونة قائمة هامبرغر، النقر عليها يوسع جميع روابط التنقل.
- **أجهزة سطح المكتب**: عرض روابط التنقل مباشرة في الهيدر، ولكن لا تتجاوز 40% من عرض الشاشة؛ يتم عرض الأجزاء التي تتجاوز ذلك من خلال قائمة منسدلة "المزيد".
