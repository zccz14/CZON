...
"summary": "Este documento es una guía para redactar informes de análisis de estilo de intervalos de tiempo históricos, diseñada para ayudar a los usuarios a organizar el contenido en orden cronológico y analizar la evolución y las tendencias de desarrollo. El documento detalla los puntos clave en los que se debe enfocar la lectura (como fechas precisas, descripción de eventos, puntos de inflexión, etc.) y proporciona sugerencias para la estructura de la base de conocimiento (incluyendo índice de archivos, línea de tiempo, división de etapas, índice de puntos de inflexión e índice de evolución temática). Además, el documento explica el posicionamiento de estilo (el público objetivo son lectores e investigadores que deseen comprender la trayectoria de desarrollo, el tono de escritura debe ser objetivo, profundo y perspicaz), los principios fundamentales (como basarse en el orden cronológico, identificar puntos de inflexión clave, hacer proyecciones razonables sobre la dirección futura) y la estructura de secciones obligatorias (incluyendo resumen, división de etapas, puntos de inflexión clave, evolución temática, predicción de trayectoria futura y conclusión). Finalmente, el documento enumera los archivos de salida y una lista de verificación de calidad para garantizar la precisión e integridad del informe."
"tags":
  - "Análisis histórico"
  - "Intervalo de tiempo"
  - "Guía de estilo"
...
Al leer cada archivo, extraiga con prioridad:

- Ruta y título del archivo
- **Fechas precisas** (prioridad más alta)
...
2. **Se puede simplificar**: División de etapas (fusionar etapas similares), evolución temática (conservar temas principales)
...
Organice la línea de tiempo, observando los cambios en el contenido desde una perspectiva de desarrollo histórico.
...
**Propósito**: Ayudar al lector a comprender el contexto histórico y el proceso de desarrollo del contenido
...
Breve introducción del rango de tiempo analizado y los hallazgos principales
...
- [Producto 1](../ruta/al/archivo.md): [Breve explicación]
- [Producto 2](../ruta/al/archivo.md): [Breve explicación]
...
Basándose en el contenido existente, proyectar razonablemente la dirección futura:

```markdown
### Predicción a Corto Plazo (1-3 meses)

Basado en [evidencia](../ruta/al/archivo.md), se espera...

### Predicción a Mediano Plazo (3-12 meses)

Según [análisis de tendencias], es posible...
