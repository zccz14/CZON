...
"summary": "Este documento es una guía sobre cómo crear informes de análisis de estilo objetivo y neutral. Detalla los puntos de atención al analizar documentos (como ruta de archivo, fecha, nombre del proyecto, roles de personas, hechos objetivos, etc.) y define la estructura de la base de conocimiento (incluyendo índices de archivos, proyectos, personas, línea de tiempo y marcos teóricos). También proporciona estrategias de compresión, guiando sobre cómo simplificar el contenido cuando sea necesario, mientras enfatiza que se deben conservar los índices clave. El posicionamiento de estilo requiere presentar el contenido desde una perspectiva objetiva y neutral, evitando evaluaciones subjetivas y matices emocionales. Los lectores objetivo incluyen nuevos lectores, colaboradores potenciales e inversores. El documento enumera prohibiciones (como no agregar expresiones emocionales o especulaciones) y la estructura de capítulos obligatoria (como Resumen, Introducción al Proyecto, Temas Clave, Línea de Tiempo, Personas Principales y Resumen del Marco Teórico), y especifica el archivo de salida y la lista de verificación de calidad."
"tags":
...
- Nombres de proyectos involucrados y descripciones de funciones
...
Presentar el contenido desde una perspectiva objetiva y neutral, evitando evaluaciones subjetivas y matices emocionales. Enfatizar hechos y datos, asegurando la precisión y confiabilidad de la información.
...
**Tono de escritura**: Profesional, comedido, neutral, como al redactar un currículum o historial.
**Propósito**: Ayudar al lector a comprender completamente la información básica y los puntos de vista centrales del contenido, para que forme su propio juicio.

## Prohibiciones

- ❌ No agregar expresiones emocionales (ej. "emocionante", "lamentablemente").
...
- ❌ No evaluar lo bueno o lo malo, lo superior o lo inferior.
...
- Rango de tiempo del contenido del repositorio.
...
- **Funciones Principales**:
  - Punto de función 1
  - Punto de función 2
- **Iteraciones de Versión**: Si hay historial de versiones, explicar brevemente.
...
Para teorías/marcos propuestos en el repositorio:

```markdown
### [Nombre del Marco]

- **Idea Central**: Resumir en una oración.
