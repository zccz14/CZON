...
'summary': 'Este es un archivo de prueba para verificar la funcionalidad de renderizado de diagramas Mermaid en CZON. El documento incluye ejemplos de varios tipos de diagramas Mermaid, como diagramas de flujo, diagramas de secuencia, diagramas de Gantt, diagramas de clases, diagramas de estado y gráficos circulares, además de una prueba de sintaxis errónea para comprobar el manejo de errores. El contenido principal muestra el código de los diagramas y su descripción, con el objetivo de probar si la integración funciona correctamente.'
'tags':
  - 'Mermaid'
  - 'Prueba de diagramas'
  - 'Diagrama de flujo'
